...
constexpr std::uint16_t ScannerServiceCharCount = 2;
...
constexpr std::string_view StateCharacteristic = "7e6bf038-0f01-47ab-a215-cf841f4289f0";
...
constexpr std::string_view DevicesCharacteristic = "7e6bf038-0f02-47ab-a215-cf841f4289f0";
