...
void AttributeTable::Service(std::string_view uuid128)
{
	...
	esp_gatts_attr_db_t entry{.attr_control = ESP_GATT_AUTO_RSP,
...
void AttributeTable::Declaration(esp_gatt_char_prop_t properties)
{
                           ...
                           esp_gatt_perm_t permissions)
{
	...
	esp_gatts_attr_db_t db{.attr_control = ESP_GATT_AUTO_RSP,
...
AttributeTableBuilder & AttributeTableBuilder::Value(std::string_view uuid128,
                                                     ...
                                                     esp_gatt_perm_t permissions)
{
	_table.Value(uuid128, length, maxLength, permissions);
	return *this;
}
